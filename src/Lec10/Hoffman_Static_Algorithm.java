...
public class Hoffman_Static_Algorithm {
	int _n;
	int [][] _mat;
	int [] _freq;
	String _code[];
	// constructor
	public Hoffman_Static_Algorithm(int freq[]){
		_n = freq.length;
...
/////////////////	
	...
	public static void check2Min(){
		...
		int arr[] = MyLibrary.randomIntegerArray(size);
		MyLibrary.printIntegerArray(arr);
		Hoffman_Static_Algorithm ha =new Hoffman_Static_Algorithm(arr);
	...
	public static void main(String[] args) {
		...
		Hoffman_Static_Algorithm ha =new Hoffman_Static_Algorithm(freq1);
		ha.HuffmanTable();
		ha.printMat();
		ha.HuffmanCode();
		ha.printCode();
