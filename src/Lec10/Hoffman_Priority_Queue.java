...
public class Hoffman_Priority_Queue {//O(nlog2(n))
	private Node nodes[];
	...
	// constructor
	public Hoffman_Priority_Queue(int freq[]){//O(n)+O(n)+O(nlog2(n))
	...
	public static void main(String[] args) {
		...
		Hoffman_Priority_Queue hh =new Hoffman_Priority_Queue(freq2);
		hh.HuffmanAlgorithm();
		hh.printCode();		
	}
